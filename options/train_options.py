...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--cd_lr', type=float, default=0.0001, help='initial learning rate for adam')
        ...
        parser.add_argument('--netCD', type=str, default='coocur', help='(n_layers|multiscale|image)')
        parser.add_argument('--lambda_kld', type=float, default=0.05)
        parser.add_argument('--lambda_feat', type=float, default=10.0, help='weight for feature matching loss')
        parser.add_argument('--lambda_vgg', type=float, default=10.0, help='weight for vgg loss')
        parser.add_argument('--GAN_CD', type=str, default="wgan", help="wgan|lsgan|hinge")
        #
